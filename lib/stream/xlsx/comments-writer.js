...
const CommentsXForm = require('../../xlsx/xform/comments');
const xformComments = new CommentsXForm()
...
CommentsWriter.prototype = {
  ...
  commit: function () {
    ...
    // Commit the comments.
    this._comments.forEach(this._writeComment.bind(this));
  ...
  _writeComment: function (comment) {
		this.stream.write(xformComments.toXml(comment))
  },
};
